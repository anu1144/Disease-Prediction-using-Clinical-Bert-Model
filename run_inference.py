...
def main(flags) -> None:
    ...
    if flags.intel:
        ...
        print("Using IPEX to optimize model")
        ...
        if flags.is_inc_int8:
            print("Using INC Quantized model")
        else:    
            print("Using stock model")
